...
export function isNotEmptyString(value?: string | null): value is string {
  return !isEmptyString(value);
}

export function isEmpty<T>(value?: T | null): value is null | undefined {
  return FF.pipe(
    value,
    FE.fromNullable(true),
    FE.chain((notNull) => {
...
export function isNotEmpty<T>(value?: T | null): value is T {
